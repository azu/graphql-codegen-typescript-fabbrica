  ...
  generates: {
    ...
    './__generated__/1-basic/fabbrica.ts': {
      ...
      config: {
        ...
        fakeOutputPath: "./__generated__/1-basic/fake.ts"
      },
    },
    ...
    './__generated__/2-typesPrefix/fabbrica.ts': {
      ...
      config: {
        ...defaultFabbricaPluginConfig,
        typesPrefix: 'Prefix',
        fakeOutputPath: "./__generated__/2-typesPrefix/fake.ts"
      },
    },
    ...
    './__generated__/3-typesSuffix/fabbrica.ts': {
      ...
      config: {
        ...defaultFabbricaPluginConfig,
        typesSuffix: 'Suffix',
        fakeOutputPath: "./__generated__/3-typesSuffix/fake.ts"
      },
    },
    ...
    './__generated__/4-non-optional-fields/fabbrica.ts': {
      ...
      config: {
        ...
        fakeOutputPath: "./__generated__/4-non-optional-fields/fake.ts"
      },
    },
  },
};
